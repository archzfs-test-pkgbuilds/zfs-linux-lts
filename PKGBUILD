...
pkgver=0.7.9.4.14.44.1
pkgrel=1
makedepends=("linux-lts-headers=4.14.44-1" "spl-linux-lts-headers")
arch=("x86_64")
...
license=("CDDL")
depends=("kmod" 'spl-linux-lts' "zfs-utils-common=0.7.9" "linux-lts=4.14.44-1")
