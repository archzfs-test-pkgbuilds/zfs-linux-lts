...
pkgver=0.7.8.4.14.40.1
pkgrel=1
makedepends=("linux-lts-headers=4.14.40-1" "libelf" "spl-linux-lts-headers")
arch=("x86_64")
...
license=("CDDL")
depends=("kmod" "spl-linux-lts" "zfs-utils-common=0.7.8" "linux-lts=4.14.40-1")
