...
pkgver=0.7.5.4.9.71.1
pkgrel=1
makedepends=("linux-lts-headers=4.9.71" "libelf" "spl-linux-lts-headers")
arch=("x86_64")
...
license=("CDDL")
depends=("kmod" "spl-linux-lts" "zfs-utils-common=0.7.5" "linux-lts=4.9.71")
